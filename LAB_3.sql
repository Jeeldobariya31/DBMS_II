...
AS
BEGIN
    SELECT EnrolmentID , EnrollmentDate , Grade , EnrollmentStatus
    FROM ENROLLMENT
...
CREATE OR ALTER PROCEDURE SP_COURSE_ASSIGNMENT 
@NAME VARCHAR(100)
AS
BEGIN
 SELECT C.CourseName 
 ...
 JOIN FACULTY F
 ON F.FacultyID = A.FacultyID
 WHERE F.FacultyName = @NAME

 END;
 GO

 EXEC SP_COURSE_ASSIGNMENT 'Dr. Patel'
...
AS
BEGIN
    SELECT E.EnrolmentID, E.StudentID, S.StuName, E.CourseID, C.CourseName, 
...
AS
BEGIN
    SELECT E.EnrolmentID, E.EnrollmentDate, S.StuName, S.StuDepartment,
